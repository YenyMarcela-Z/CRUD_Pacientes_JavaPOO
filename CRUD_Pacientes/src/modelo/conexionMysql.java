...
public class conexionMysql {
    ...
    public Connection conexion(){  //método público conexion
        ...
        try{ //captura los errores
            ...
            conectar=DriverManager.getConnection("jdbc:mysql://localhost/bdcrudpaciente?useSSL=false&serverTimezone=America/Bogota","root","admin123"); //inicializamos nuestra variable conectar
